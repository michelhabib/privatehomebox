...
auth roles, message content types, and reconnect policy used by all PHB
channel packages and the phbcli/phbgateway servers.
"""
...
# ---------------------------------------------------------------------------
# WebSocket close codes (PHB application range 4000–4999)
# ---------------------------------------------------------------------------
